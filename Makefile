...
ftpserver: bin/server/concurrent/ftpserver-fork.c bin/onexit.c bin/server/concurrent/do_server_fork_syst_cmd.c bin/server/concurrent/do_server_fork_cwd_cmd.c bin/server/concurrent/do_server_fork_pwd_cmd.c bin/server/concurrent/do_server_fork_dele_cmd.c bin/server/concurrent/do_server_fork_mkd_cmd.c bin/server/concurrent/do_server_fork_rmd_cmd.c bin/server/concurrent/do_server_fork_rnm_cmd.c bin/server/concurrent/do_server_fork_retr_cmd.c bin/server/concurrent/do_server_fork_stor_cmd.c bin/server/concurrent/do_server_fork_list_cmd.c bin/server/concurrent/list-files.c bin/server/concurrent/free-file-list.c bin/server/concurrent/get_syst.c bin/server/concurrent/get_server_public_ip.c bin/server/concurrent/check_login_details.c
	@echo "--> Compiling server..."
	@$(CC) $(CFLAGS) -lcurl -lcrypto -o ftpserver bin/server/concurrent/ftpserver-fork.c bin/onexit.c bin/server/concurrent/do_server_fork_syst_cmd.c bin/server/concurrent/do_server_fork_cwd_cmd.c bin/server/concurrent/do_server_fork_pwd_cmd.c bin/server/concurrent/do_server_fork_dele_cmd.c bin/server/concurrent/do_server_fork_mkd_cmd.c bin/server/concurrent/do_server_fork_rmd_cmd.c bin/server/concurrent/do_server_fork_rnm_cmd.c bin/server/concurrent/do_server_fork_retr_cmd.c bin/server/concurrent/do_server_fork_stor_cmd.c bin/server/concurrent/do_server_fork_list_cmd.c bin/server/concurrent/list-files.c bin/server/concurrent/free-file-list.c bin/server/concurrent/get_syst.c bin/server/concurrent/get_server_public_ip.c bin/server/concurrent/check_login_details.c
	@echo "--> ...done"
