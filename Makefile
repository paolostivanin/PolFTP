...
ftpclient: bin/ftpclient.c
	...
	@gcc -Wall -O2 -D_FORTIFY_SOURCE=2 -fstack-protector -o ftpclient bin/ftpclient.c bin/clear_buf.c
	@echo "--> ...done"
	
ftpclient: bin/ftpserver.c
	@echo "--> Compiling server..."
	@gcc -Wall -O2 -D_FORTIFY_SOURCE=2 -fstack-protector -o ftpserver bin/ftpserver.c bin/list-files.c bin/onexit.c bin/clear_buf.c
	@echo "--> ...done"
